...
public class InspectAPI6 {
    public static void main(String[] args) throws Exception {
        ...
        Class<?> clazz = loader.loadClass("io.papermc.paper.registry.data.dialog.body.ItemDialogBody");

        System.out.println("Methods in ItemDialogBody:");
