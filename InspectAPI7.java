...
public class InspectAPI7 {
    public static void main(String[] args) throws Exception {
        ...
        Class<?> clazz = loader.loadClass("io.papermc.paper.registry.data.dialog.body.PlainMessageDialogBody");

        System.out.println("Methods in PlainMessageDialogBody:");
